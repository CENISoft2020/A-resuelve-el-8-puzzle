...
# Función para crear el árbol del puzzle
...
# Función para graficar el árbol con un layout Spring
def plot_tree(G):
    pos = nx.spring_layout(G, seed=42)  # Establecer una semilla para la reproducibilidad
